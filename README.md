<img width="1849" height="1194" alt="Screenshot_45" src="https://github.com/user-attachments/assets/f4ea8d79-7ce8-4e20-a6a1-e4be2c760de9" />
...
This code is partly handwritten and vibecoded with Claude.ai

---------------------------------

Deployment

#1 Start up the Notebook
#2 Copy the cLoudflare Adress and Paste it into the WebUI
#3 Go :)
